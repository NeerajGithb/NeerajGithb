...
**Features:** User authentication, product management, shopping cart, order tracking, payment gateway
...
#### 🔗 [URL Shortener Service](https://github.com/NeerajGithb/url-shortener)
Fast and efficient URL shortening service with analytics tracking.

**Tech Stack:** Next.js, MongoDB  
**Features:** Custom short links, click analytics, QR code generation
